  ...
  return (
    <LegalLayout title="Política de privacidad" updated="Junio 2026">
      ...
      <p>
        ...
        teléfono: nombre, número de teléfono, zona y el detalle del trabajo de
        plomería o gas que necesitás.
      </p>

      <h2>Para qué los usamos</h2>
      <p>
        Usamos tus datos exclusivamente para responder tu consulta, coordinar la
        visita del técnico, elaborar el presupuesto y darte seguimiento. No los
