...
export default function Terminos() {
  return (
    <LegalLayout title="Términos y condiciones" updated="Junio 2026">
      ...
      <h2>Servicios</h2>
      <p>
        {site.brandFull} ofrece servicios de plomería, gas, destapaciones e
        instalación sanitaria para hogares, edificios y comercios en {site.region}.
        Los trabajos de gas son realizados por un gasista matriculado. Antes de
        iniciar cualquier trabajo se informa el presupuesto, que el cliente debe
        aceptar.
      </p>
      ...
      <p>
        ...
        precios pueden variar según el tipo de trabajo, la complejidad de la
        reparación o instalación y los materiales necesarios. El precio final se
        confirma antes de comenzar.
      </p>

      <h2>Garantía</h2>
      <p>
        Las reparaciones, instalaciones y materiales cuentan con garantía. La
        ...
        falta de mantenimiento o intervención de terceros.
      </p>
      ...
      <p>
        ...
        zona y la demanda. Este es un sitio de demostración: la marca, los datos de
        contacto y las reseñas son ilustrativos.
      </p>
