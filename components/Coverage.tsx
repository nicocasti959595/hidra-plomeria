      ...
      <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-4 text-mist max-w-lg">
            Vamos con nuestros plomeros y gasistas matriculados a tu casa, edificio
            o comercio para reparar, destapar o instalar. Estos son algunos de los
            barrios y localidades donde trabajamos a diario:
          </p>
          ...
          <div className="glass rounded-3xl p-3 shadow-2xl">
            <div className="overflow-hidden rounded-2xl border border-line">
              <iframe
                ...
                src="https://www.openstreetmap.org/export/embed.html?bbox=-58.62%2C-34.74%2C-58.30%2C-34.52&layer=mapnik&marker=-34.6125%2C-58.4742"
