...
import { IconWhatsApp, IconPhone, IconFlame } from "./Icons";

export default function EmergencyCTA() {
  return (
    <section className="py-12">
      <div className="mx-auto max-w-7xl px-4">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-heat-deep via-heat to-heat-bright px-6 py-12 sm:px-12 sm:py-14">
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
            <div className="max-w-2xl">
              <p className="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1 text-xs font-bold text-white">
                <IconFlame className="h-4 w-4" /> ¿PÉRDIDA DE GAS O AGUA?
              </p>
              <h2 className="mt-4 font-display text-3xl sm:text-4xl font-extrabold text-white">
                ¿Olor a gas o una pérdida de agua que no para?
              </h2>
              <p className="mt-3 text-white/90 text-lg">
                No lo dejes pasar. Tenemos guardia las 24 horas para urgencias de
                gas, agua y destapaciones. Llamanos o escribinos y salimos ya.
              </p>
            </div>
