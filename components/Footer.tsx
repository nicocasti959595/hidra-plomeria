...
import { DropLogo, IconPhone, IconWhatsApp } from "./Icons";
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-mist max-w-xs">
              Plomería, gas y destapaciones en {site.region}. Gasista matriculado,
              urgencias 24 hs y trabajos con garantía por escrito.
            </p>
