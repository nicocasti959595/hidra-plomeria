      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-3xl sm:text-4xl font-extrabold text-white">
            Plomería y gas, de la urgencia a la obra
          </h2>
          <p className="mt-4 text-mist">
            Hogar, edificio o comercio. Reparamos pérdidas, destapamos, instalamos
            gas y sanitarios, y dejamos todo funcionando con materiales de calidad
